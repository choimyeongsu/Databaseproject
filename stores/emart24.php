...
<?php
                ...
                $query ="select * from db where brand='emart24' order by tag";
        ...
        <body>
          ...
          <div id="search_box">
            ...
            if(isset($_POST["submit"])){
                ...
                //데이터베이스에 쿼리 명령문을 보낸다
                $sth=$con->prepare("SELECT * FROM db WHERE name like '%$str%' and brand='emart24'");
...
<?php
        ...
        ?>
        <h1 align=center>Emart24 제품 정보 모음</h1>
        <table align = center>
        <thead align = "center">
        <tr style ="font-weight:bold;">
        <td width = "300" align = "center">상호명</td>
